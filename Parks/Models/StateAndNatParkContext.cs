  ...
  public class StateAndNatParkContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      builder.Entity<StateAndNatPark>()
        .HasData(
          new StateAndNatPark { StateAndNatParkId = 1, Name = "Yosemite", Type = "National Park", LocationByState = "California" },
          new StateAndNatPark { StateAndNatParkId = 2, Name = "Jellystone", Type = "National Park", LocationByState = "Wyoming" },
